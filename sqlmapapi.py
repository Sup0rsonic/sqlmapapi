...
# Written by Sup0rsonic from BREAHCERS security.
...
if dev_mode: # SWEP debug options. Don't touch.
...
class sqlmapApi():
    def __init__(self): # Modify your options here.
        self.sqlmapApiHost = "YOUR SQLMAPAPI HOST"
        self.sqlmapApiPort = "YOUR SQLMAPAPI PORT"
        self.sqlmapPath = "YOUR SQLMAPAPI FILE DIR"
        self.ParmList = {}
